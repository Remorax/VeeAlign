...
class DataParser():
    ...
    def run_spellcheck(self, inp):
        ...
        # Enter your API key here if you wish to use RapidAPI
        headers = {
        }
    ...
    def process(self, spellcheck=False, bag_of_neighbours=False):
        ...
        if self.language=="en":
            ...
            # Temporarily commented out. If you wish to run it, please create a GrammarBot account on RapidAPI (its' free till a certain limit) and enter the relevant API keys in `run_header`
